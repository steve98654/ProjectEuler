...
syn keyword matlabConditional		switch case else elseif end if otherwise break continue endif endfor
...
"Low-Level File I/O
syn keyword matlabFunc fclose feof fgetl fgets fopen fprintf printf fread frewind fscanf fseek ftell fwrite 
